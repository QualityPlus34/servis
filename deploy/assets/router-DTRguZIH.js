...
const appCss = "/assets/styles-D--iQNbq.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Quality Plus — Ремонт стиральных, посудомоечных и сушильных машин" },
      { name: "description", content: "Сервисный центр премиум-класса. Ремонт бытовой техники Bosch, Siemens, Miele, LG, Samsung, Electrolux. Гарантия до 2 лет." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Quality Plus" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1a1a1a" },
      { property: "og:title", content: "Quality Plus — Ремонт стиральных, посудомоечных и сушильных машин" },
      { name: "twitter:title", content: "Quality Plus — Ремонт стиральных, посудомоечных и сушильных машин" },
      { property: "og:description", content: "Сервисный центр премиум-класса. Ремонт бытовой техники Bosch, Siemens, Miele, LG, Samsung, Electrolux. Гарантия до 2 лет." },
      { name: "twitter:description", content: "Сервисный центр премиум-класса. Ремонт бытовой техники Bosch, Siemens, Miele, LG, Samsung, Electrolux. Гарантия до 2 лет." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/81c8c688-c2ba-4b1a-8bfc-7259badce962/id-preview-1374b142--620f6933-7b8e-4122-8492-f720eeaee81f.lovable.app-1778696591433.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/81c8c688-c2ba-4b1a-8bfc-7259badce962/id-preview-1374b142--620f6933-7b8e-4122-8492-f720eeaee81f.lovable.app-1778696591433.png" }
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Montserrat:wght@500;600;700;800;900&display=swap"
      }
    ]
  }),
...
const TG_HREF = "https://t.me/EvaremservisRam23";
const YA_HREF = "https://yandex.ru/profile/15987999957?lang=ru";
const $$splitComponentImporter = () => import("./index-Dcyhm3Jy.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "Quality Plus — Премиальный ремонт стиральных, посудомоечных и сушильных машин"
    }, {
      name: "description",
      content: "Сервисный центр Quality Plus: ремонт стиральных, посудомоечных и сушильных машин премиум-класса. 10 лет опыта, оригинальные запчасти, гарантия до 2 лет, выезд за 30 минут."
    }, {
      property: "og:title",
      content: "Quality Plus — Ремонт премиальной бытовой техники"
    }, {
      property: "og:description",
      content: "Точность. Надёжность. Ремонт, которому доверяют. Bosch, Siemens, Miele, LG, Samsung, Electrolux."
    }, {
      property: "og:type",
      content: "website"
    }, {
    ...
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        "@type": "LocalBusiness",
        name: "Quality Plus",
        description: "Сервисный центр премиум-класса по ремонту стиральных, посудомоечных и сушильных машин.",
        telephone: "+79771841287",
        priceRange: "$$",
        areaServed: "Москва и область",
        sameAs: [TG_HREF, YA_HREF]
      })
    }]
  }),
